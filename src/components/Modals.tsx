...
// Sunucu ikonu için circular=false, 1:1 crop
function ImageCropperModal({ src, onConfirm, onCancel }: { src: string; onConfirm: (url: string) => void; onCancel: () => void }) {
  return <ImageCropper src={src} aspectRatio={1} circular={true} onConfirm={onConfirm} onCancel={onCancel} />;
}
